...
def build_onliner_url(config: dict):
    base_url = 'https://pk.api.onliner.by/search/apartments?number_of_rooms[]=' + config['number_of_rooms'] + \
...
onliner_base_url = build_onliner_url(DEFAULT_CONFIG)
rs = http_get(onliner_base_url + park_chel)
